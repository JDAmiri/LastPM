...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `opportunity_solution_tree_mapper` to map this Job to be Done into a feature roadmap, or `behavioral_friction_analyzer` to design the exact user flow changes that address the strongest Inhibiting Pressure identified.
</router_directives>
