---
agent_name: olsen_opportunity_score
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `torres_opportunity_solution_tree` to map the top-scoring opportunity into a validated solution tree, or `olsen_opportunity_score` to test this prioritization against competing personas.
</router_directives>
