---
agent_name: rachitsky_one_pager
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `singer_shape_up_pitch` to add time-bound appetite and no-gos to this 1-pager, or `duke_kill_criteria_setter` to define failure conditions before engineering begins.
</router_directives>
