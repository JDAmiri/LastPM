---
name: lean_one_pager_prd
description: "Transform bloated product concepts into an ultra-lean 1-page PRD. Triggered via scoring at Green Light. Triggers: lean one-pager, summary, one pager, extracting the core value prop from a messy notion doc, quick scannable document to approve resourcing"
---
---
