---
name: competitive_moat_analyzer
description: "Evaluate if and how a proposed feature creates a defensible competitive moat using 7 Powers. Routed via scoring when Defensibility score is 0-3 (needs moat). Triggers: moat, 7 powers, defensibility, competitive advantage, justifying a massive new product bet, analyzing a competitor's launch"
---
---
...
SEARCH_QUERIES:
  - "[Primary Competitor 1] product capabilities features [current year]"
  - "[Primary Competitor 2] recent strategic moves acquisitions"
  - "[Industry] switching costs barriers to entry analysis"
FETCH_TARGETS: []
ENRICHMENT_GOAL: Validate the 7 Powers assessment with real competitor capabilities and recent moves. Verify claimed moats against actual market evidence. Every external data point must carry a confidence label.
</research_directives>
