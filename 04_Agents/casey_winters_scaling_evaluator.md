---
agent_name: casey_winters_scaling_evaluator
...
1. Current Retention Metrics (e.g., "Month 1 retention is 40%, flattening to 25% by Month 6")
2. Current Acquisition Channels (e.g., "Mainly founder-led sales and paid LinkedIn ads")
3. Manual Processes Currently in Place (e.g., "We manually onboard every user via a 30-minute Zoom call and hand-configure their dashboard")
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `balfour_growth_loop_architect` to design the specific self-sustaining growth loop for scaling, or `verna_monetization_modeler` to determine whether PLG or SLG is the right motion for this stage.
</router_directives>
