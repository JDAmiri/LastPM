---
agent_name: madhavan_wtp_survey_designer
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `madhavan_feature_shock_preventer` to classify the feature set against willingness-to-pay signals, or `good_better_best_architect` to translate the validated pricing data into a concrete tier structure.
</router_directives>
