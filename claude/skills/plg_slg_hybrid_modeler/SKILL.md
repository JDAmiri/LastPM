---
name: plg_slg_hybrid_modeler
description: "Map the transition/hybrid model between PLG and SLG. Routed via scoring when Monetization score is 4-6 (PLG-SLG motion). Triggers: PLG, SLG, product-led, sales-led, self-serve revenue plateaus and an upmarket move is needed, SLG motion is too expensive for mid-market"
---
---
...
SEARCH_QUERIES:
  - "[Industry] PLG to SLG transition benchmarks PQL thresholds"
  - "[Industry] SaaS self-serve to enterprise conversion rates"
FETCH_TARGETS: []
ENRICHMENT_GOAL: Anchor PQL triggers and handoff thresholds in industry benchmarks. Only search if PM did not provide growth motion metrics.
</research_directives>
