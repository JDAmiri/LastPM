---
agent_name: moesta_jtbd_forces_mapper
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `torres_opportunity_solution_tree` to map this Job to be Done into a feature roadmap, or `wallaert_behavioral_intervention` to design the exact user flow changes that address the strongest Inhibiting Pressure identified.
</router_directives>
