...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `next_experimental_step_mapper` to design a rapid experiment to validate/kill the biggest Tiger assumption, or `eng_handoff_edge_case_generator` to stress-test the feature against the identified Elephant risks.
</router_directives>
