---
agent_name: dunford_positioning_canvas
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `moore_chasm_beachhead_mapper` to isolate the specific beachhead market for this positioning, or `launchengco_b2b_buyer_persona` to expand the positioning into a full buying committee narrative.
</router_directives>
