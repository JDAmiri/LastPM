---
agent_name: bambu_activation_milestone_definer
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `wallaert_behavioral_intervention` to diagnose friction points preventing users from hitting this milestone, or `perri_product_kata` to design the experiment to test whether improving activation actually impacts retention.
</router_directives>
