---
name: enterprise_risk_scenario_architect
description: "Enterprise Risk Assessment & Scenario Planning. Triggers: enterprise risk, scenario planning, stress test, black swan, risk matrix, ERM, downside protection, risk register, venture risk, stress-testing strategy for board review, volatile macro-environment"
---
