---
name: data_flywheel_architect
description: "Design frictionless human-in-the-loop feedback mechanisms to continuously improve AI model performance. Routed via scoring when Defensibility score is 4-6 (AI/data product). Triggers: data flywheel, RLHF, human in the loop, launching a new GenAI feature and needing RLHF capture from day one"
---
---
...
2. Current User Journey / Output Format
3. Primary Model Failure Mode (what needs improving?)
