---
name: appetite_based_pitch_drafter
description: "Format an idea into a Basecamp Shape Up pitch (Problem, Appetite, Solution, Rabbit Holes, No-Gos). Triggered via scoring at Green Light. Triggers: shape up, appetite, pitch, 6-week cycle, loose feature idea that needs constraining, engineering frequently over-engineers solutions"
---
---
