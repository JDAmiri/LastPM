---
name: career_leverage_auditor
description: "Audit a PM calendar and task list to ruthlessly prioritize high-leverage work using the LNO framework. Triggers: career leverage, burnout, zero progress, feeling burned out but making zero progress on core strategy, planning the upcoming week or sprint"
---
---
agent_name: career_leverage_auditor
...
2. Current Primary Goal (the #1 thing you are paid to achieve)
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `eisenhower_time_audit` for a weekly operational audit, or use this LNO framework to renegotiate their role boundaries with their manager.
</router_directives>
