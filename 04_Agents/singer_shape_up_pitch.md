---
agent_name: singer_shape_up_pitch
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `eng_handoff_edge_case_generator` to stress-test the solution shape for missing edge cases before engineering kickoff, or `perri_product_kata` to structure a rapid prototype/validation cycle before the full build.
</router_directives>
