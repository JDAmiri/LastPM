---
agent_name: helmer_7_powers_moat_analyzer
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `gibson-biddle-dhm-evaluator` to validate the Margin and Delight dimensions of the identified moat, or `casey_winters_scaling_evaluator` to assess whether this initiative is ready to be scaled.
</router_directives>
