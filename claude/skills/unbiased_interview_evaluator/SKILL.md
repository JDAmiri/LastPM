---
name: unbiased_interview_evaluator
description: "Objectively analyze user interview transcripts and rewrite leading questions into past-behavior-focused inquiries. Triggers: leading questions, bias, transcript, finishing a customer discovery call, reviewing a junior PM interview script"
---
---
agent_name: unbiased_interview_evaluator
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run a new round of interviews with the improved Mom Test questions, or run `jtbd_forces_mapper` on the *validated* insights from this cleaned transcript to extract the true JTBD drivers.
</router_directives>
