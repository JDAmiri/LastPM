---
name: tiering_strategy_architect
description: "Structure SaaS tiering based on distinct customer segments and value fences. Routed via scoring when Monetization score is 4-6 (tier/packaging). Triggers: tiering, saas tiers, packaging, value fence, deciding which features belong in which tier, high enterprise downgrade rates"
---
---
...
SEARCH_QUERIES:
  - "[Industry] SaaS tiering packaging benchmarks [current year]"
  - "[Primary Competitor] pricing tiers feature allocation"
FETCH_TARGETS: []
ENRICHMENT_GOAL: Benchmark proposed tier structure and value fences against peer pricing and packaging. Only search if PM did not provide competitive tier data.
</research_directives>
