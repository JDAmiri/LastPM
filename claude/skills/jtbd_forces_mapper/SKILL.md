---
name: jtbd_forces_mapper
description: "Map customer interviews into the 4 Forces of Jobs to be Done. Routed via scoring when Delight score is 0-3 (motivation unknown). Triggers: JTBD, 4 forces, job to be done, processing a batch of user interviews about product switching, adoption is stalling despite assumed value"
---
---
