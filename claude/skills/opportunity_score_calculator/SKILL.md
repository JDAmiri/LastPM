---
name: opportunity_score_calculator
description: "Calculate Opportunity Score = Importance + (Importance - Satisfaction). Triggers: opportunity score, importance vs satisfaction, massive backlog and need an objective filter, analyzing recent user interview or survey data for the biggest gap"
---
---
