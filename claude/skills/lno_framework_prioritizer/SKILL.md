---
name: lno_framework_prioritizer
description: "Categorize roadmap items into Leverage, Neutral, and Overhead. Triggers: LNO, leverage neutral overhead, planning a quarter with a laundry list of equally weighted P1s, engineering team is bottlenecked, weekly sprint planning to identify 5-min vs 5-hour tasks"
---
---
