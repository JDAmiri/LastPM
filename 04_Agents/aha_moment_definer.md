...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `behavioral_friction_analyzer` to diagnose friction points preventing users from hitting this milestone, or `next_experimental_step_mapper` to design the experiment to test whether improving activation actually impacts retention.
</router_directives>
