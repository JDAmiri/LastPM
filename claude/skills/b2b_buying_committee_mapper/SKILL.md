---
name: b2b_buying_committee_mapper
description: "Differentiating User, Champion, and Buyer in B2B Sale. Triggers: buying committee, economic buyer, enterprise sales, preparing product marketing messaging or landing pages, enterprise sales are stalling and trials aren't converting"
---
---
...
1. Target Company Profile / Industry
2. Core Product/Feature Value Prop
3. Known End-User Pain Point
...
SEARCH_QUERIES:
  - "[Industry] B2B buying committee roles decision makers"
  - "[Target Company Profile] organizational structure"
FETCH_TARGETS: []
ENRICHMENT_GOAL: Validate buying committee norms and title conventions for the target industry. Only search if PM did not provide detailed buyer context.
</research_directives>
