---
agent_name: gibson-biddle-dhm-evaluator
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `helmer_7_powers_moat_analyzer` to do a deep structural analysis of the moat identified here, or `dunford_positioning_canvas` to translate the validated strategy into a differentiated market position.
</router_directives>
