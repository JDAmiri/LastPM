---
name: launch_risk_pre_mortem
description: "Categorize project risks into Tigers, Paper Tigers, and Elephants before a launch. Routed via scoring when Feasibility score is 0-3 (launch/legal risk). Triggers: paper tigers, pre-mortem, launch risk, 2 to 4 weeks out from a major launch"
---
---
agent_name: launch_risk_pre_mortem
