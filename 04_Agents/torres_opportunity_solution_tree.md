---
agent_name: torres_opportunity_solution_tree
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `moesta_jtbd_forces_mapper` to deepen understanding of the emotional drivers behind the top opportunity, or `fitzpatric_mom_test_evaluator` to audit whether the interviews generating these opportunities used good discovery technique.
</router_directives>
