---
name: ai_ux_fallback_designer
description: "Design trust-preserving UX recovery paths for inevitable AI failures, hallucinations, or timeouts. Routed via scoring when Feasibility score is 4-6 (AI error handling). Triggers: hallucination, AI error, fallback, sad path, implementing generative data extraction with user review edit reject workflow"
---
---
