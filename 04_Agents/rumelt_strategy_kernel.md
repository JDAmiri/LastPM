---
agent_name: rumelt_strategy_kernel
...
1. Current Situation / Market Challenge (e.g., "We are losing mid-market users to a cheaper competitor")
2. Proposed Solution / Leadership Goals (e.g., "Build an AI chatbot, increase retention by 15%")
3. Key Constraints / Resources (e.g., "2 engineering squads, 6-week timeline")
...
NEXT_STEP_SUGGESTION: Ask the user if they want to run `roger_martin_strategic_cascade` to expand the kernel into a full 5-choice strategic cascade, or `helmer_7_powers_moat_analyzer` to validate that the Guiding Policy builds a defensible competitive advantage.
</router_directives>
