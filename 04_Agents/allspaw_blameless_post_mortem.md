---
agent_name: allspaw_blameless_post_mortem
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to prioritize the highest-impact systemic remediation using `shreyas_lno_prioritizer`, or escalate the most critical resilience failure to engineering leadership for immediate structural fixes.
</router_directives>
