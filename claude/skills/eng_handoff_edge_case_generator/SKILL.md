---
name: eng_handoff_edge_case_generator
description: "Systematically scan a PRD to identify missing technical UX and operational edge cases prior to engineering handoff. Routed via scoring when Feasibility score is 4-6 (tech debt/edge cases). Triggers: edge cases, error states, empty states, preparing for sprint planning with a finished PRD"
---
---
...
3. Known External Dependencies (e.g., Stripe API, legacy DB)
