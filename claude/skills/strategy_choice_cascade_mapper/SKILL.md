---
name: strategy_choice_cascade_mapper
description: "Force definition of 5 strategic choices (Winning Aspiration, Where to Play, How to Win). Routed via scoring when Defensibility score is 4-6 (strategy/direction unclear). Triggers: where to play, how to win, kicking off a new product line or zero-to-one initiative, annual or quarterly strategic pivots"
---
---
