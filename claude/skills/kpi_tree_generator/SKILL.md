---
name: kpi_tree_generator
description: "Map a single lagging North Star metric down to specific leading behaviors the team can control. Triggers: KPI tree, leading indicators, handed a massive business target and needing to isolate what your pod influences, dashboard is full of lagging indicators"
---
---
agent_name: kpi_tree_generator
...
1. Target North Star Metric / Goal
2. Product Context / Core User Journey
3. Current Team Focus Area
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `growth_equation_builder` to validate the tree against the company's core growth equation, or `lno_framework_prioritizer` to prioritize roadmap items based on their predicted impact on these Level 3 behaviors.
</router_directives>
