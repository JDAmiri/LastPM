---
name: opportunity_solution_tree_mapper
description: "Map Outcomes to Opportunities to Solutions to Tests, flagging orphaned solutions. Routed via scoring when Delight score is 0-3 (no clear problem). Triggers: OST, opportunity solution tree, reverse-engineering a messy feature backlog, synthesizing user interviews into a structured opportunity tree"
---
---
