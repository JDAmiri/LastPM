---
name: retention_curve_analyzer
description: "Analyze cohort data to determine if retention is flattening (PMF) or trending to zero. Triggers: retention, cohorts, flattening retention, leaky bucket, deciding to scale and verifying long-term sticky retention, funnel diagnostics, drop-off"
---
---
