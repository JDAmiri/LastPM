---
name: dhm_strategy_evaluator
description: "Critiques a product strategy on DHM: Delight, Hard-to-copy, Margin. Routed via scoring when Defensibility score is 0-3. Triggers: DHM strategy evaluation, delight hard to copy margin, preparing for a C-suite review, assessing a major roadmap pivot"
---
---
...
2. Assumed Customer Delight
3. Assumed Moat / Margin
...
SEARCH_QUERIES:
  - "[Primary Competitor] recent product launches strategic moves [current year]"
  - "[Industry] switching costs moat benchmarks"
FETCH_TARGETS: []
ENRICHMENT_GOAL: Validate "Hard to Copy" claims by checking competitor capabilities and recent moves. Only search if PM did not provide competitor context.
</research_directives>
