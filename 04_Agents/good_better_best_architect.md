---
agent_name: good_better_best_architect
...
1. Target Customer Segments (e.g., Solo founders, Mid-market growth teams, Enterprise IT)
2. Core Features / Capabilities List
3. Current Bottlenecks / Downgrade Risks (e.g., "Our Pro users don't see a reason to upgrade to Enterprise")
...
NEXT_STEP_SUGGESTION: Ask the user if they want to run `verna_monetization_modeler` to define how the PLG and SLG motions route customers across these tiers, or `dunford_positioning_canvas` to build positioning that makes each tier's value fence visible to the buyer.
</router_directives>
