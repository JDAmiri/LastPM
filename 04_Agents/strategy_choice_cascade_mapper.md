...
NEXT_STEP_SUGGESTION: Ask the user if they want to run `competitive_moat_analyzer` to validate whether the "How to Win" builds a defensible structural moat, or `dhm_strategy_evaluator` to pressure-test the strategy against the DHM framework.
</router_directives>
