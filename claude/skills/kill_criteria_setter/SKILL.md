---
name: kill_criteria_setter
description: "Define strict observable conditions under which a product initiative must be killed or pivoted before development begins. Triggered via scoring at Green Light. Triggers: kill criteria, quit conditions, when to stop, finalizing a PRD to define when to stop building"
---
---
