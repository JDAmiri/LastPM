---
agent_name: fishman_growth_equation_builder
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `cutler_kpi_tree_generator` to map this equation into a hierarchical KPI tree tied to daily executable levers, or `shreyas_lno_prioritizer` to apply the LNO framework to which input variables to optimize in the current cycle.
</router_directives>
