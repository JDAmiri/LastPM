---
agent_name: bastow_now_next_later
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `cutler_kpi_tree_generator` to map the Now/Next/Later buckets to specific measurable outcomes, or `shreyas_lno_prioritizer` to apply the LNO lens to ensure the Now bucket maximizes business impact.
</router_directives>
