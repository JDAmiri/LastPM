---
agent_name: madhavan_feature_shock_preventer
...
PDR_TRIGGER: False.
NEXT_STEP_SUGGESTION: Ask the user if they want to run `good_better_best_architect` to package the confirmed Leaders into a tier structure, or `madhavan_wtp_survey_designer` to run a Van Westendorp survey on the most uncertain Leader candidate.
</router_directives>
