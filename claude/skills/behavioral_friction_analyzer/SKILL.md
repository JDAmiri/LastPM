---
name: behavioral_friction_analyzer
description: "Analyze a user flow to identify Promoting and Inhibiting Pressures on target behavior. Routed via scoring when Delight score is 0-3 (UX block). Triggers: friction, behavioral intervention, drop-off reason, funnel drop-offs in onboarding, feature adoption is low despite high assumed user value"
---
---
agent_name: behavioral_friction_analyzer
...
1. Target Behavior (what exactly should the user do?)
