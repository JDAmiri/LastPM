---
agent_name: roger_martin_strategic_cascade
...
NEXT_STEP_SUGGESTION: Ask the user if they want to run `helmer_7_powers_moat_analyzer` to validate whether the "How to Win" builds a defensible structural moat, or `gibson-biddle-dhm-evaluator` to pressure-test the strategy against the DHM framework.
</router_directives>
